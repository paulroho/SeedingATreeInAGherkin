...
namespace Builders
{
    ...
    public class OrgStructBuildingTests
    {
        ...
        {
            var orgBrd = new Org("Board", "Executive Board", OrgType.Executive);
            var orgHOFin = new Org("HOFin", "Head Office Finance", OrgType.Executive, orgBrd);
            var orgHOTech = new Org("HOTech", "Head Office Technology", OrgType.Executive, orgBrd);
            var orgSds = new Org("SWDevSvc", "Software Development Services", OrgType.Department, orgHOTech);
            var orgSwPmo = new Org("SWPmo", "Software Development PMO", OrgType.Normal, orgSds);
            var orgSwEng = new Org("SWEng", "Software Development Engineering", OrgType.Normal, orgSds);
